...
class PaymentHandler: NSObject {
    ...
    func startPayment(books: [Book], total: Int, completion: @escaping PaymentCompletionHandler) {
        ...
        books.forEach { product in
            let item = PKPaymentSummaryItem(label: product.bookname, amount: NSDecimalNumber(string: "\(product.price).00"), type: .final)
