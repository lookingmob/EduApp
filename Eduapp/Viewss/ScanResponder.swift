...
//  Eduapp
//
//  Created by alaa gharbi on 3/1/2023.
//

import UIKit
import SwiftUI

class ScanResponder: UIViewController {

    override func viewDidLoad() {
        super.viewDidLoad()
      //  let controller = UIHostingController(rootView: QuizIntroSwiftUIView())
        let controller = UIHostingController(rootView: ScanerView())
